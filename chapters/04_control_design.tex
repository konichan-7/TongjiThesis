...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/ch04/vmc.png}
  \caption{VMC 虚拟控制示意图}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/ch04/balance_response.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/ch04/velocity_tracking.png}
