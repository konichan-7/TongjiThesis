...
机器人技术是推动制造业升级和新兴产业发展的关键技术之一。习近平总书记指出，要”以科技创新推动产业创新，积极培育新能源、新材料、先进制造、电子信息等战略性新兴产业，积极培育未来产业，加快形成新质生产力，增强发展新动能”。我国在《”十四五”机器人产业发展规划》\cite{miit2021} 中明确了机器人技术在制造、服务和特种领域的应用方向，提出到 2025 年制造业机器人密度较 2020 年翻番；工信部 2023 年发布的《”机器人+”应用行动实施方案》\cite{miit2023} 进一步重申了这一目标。
...
机械结构方面：串联构型工作空间大，但腿部转动惯量高、刚度不足；并联构型承载能力强、结构紧凑，但运动范围受限、机构复杂。Liu 等人通过 DIABLO 机器人\cite{liu2024diablo} 尝试了全直驱的简化路线——6 个无减速器电机直接驱动串联腿，以二阶倒立摆近似动力学，用 LQR 完成平衡控制。这一方案回避了并联支链的复杂度，但也放弃了并联结构分担负载和增强侧向刚度的优势。混合式构型试图同时吸收两种构型的长处，但现有平台多服务于高性能验证，在小型化、紧凑化和低成本方向的尝试仍然偏少。

控制方法方面：WBC 和 MPC 依赖高精度模型和在线 QP 求解，强化学习依赖大量训练数据，它们在嵌入式平台上的实时部署都存在障碍。Yu 等人\cite{yu2023mpc} 的分层 MPC 方案通过 VMC 概念忽略腿部动力学以降低模型阶数，但滚动优化的在线计算量依然不低。Nguyen 等人提出的 TinyMPC\cite{nguyen2024tinympc} 将 MPC 求解压缩到了微控制器级别，证明轻量化是可能的，但验证场景是四旋翼而非轮腿系统。在 LQR-VMC 这条线上，Yang 等人\cite{yang2024integrated} 的方案采用自适应 LQR 和轨迹方程加速 VMC——但其重心在仿真，物理实验较少，尚未形成完整的闭环验证链条。总体而言，面向工程实现的双轮足机器人仍需在平衡控制、腿部调节和侧向稳定之间建立计算量较低、结构清晰且便于嵌入式部署的控制方法。

\section{本文主要研究内容及章节安排}

本文以小型混合式双轮足机器人为研究对象，围绕机械结构设计、运动学与动力学建模、分层平衡控制以及仿真与样机实验验证展开研究。机械结构方面，完成整机构型、闭环腿部机构、传动系统和驱动单元的设计与参数确定；建模分析方面，建立机器人平面等效运动学与动力学模型，推导线性化状态空间方程，并给出五连杆机构的任务空间到关节空间力矩映射；控制方法方面，提出 LQR-VMC 分层控制架构，利用 LQR 实现机体平衡、速度跟踪和腿摆控制，利用 VMC 实现腿长方向支撑，并通过滚转角差动补偿提高侧向稳定性；实验验证方面，在 MuJoCo 仿真和物理样机平台上对原地平衡、速度跟踪、扰动恢复、腿长调节和滚转稳定等工况进行验证。全文共六章，具体章节安排如下。
...
第6章为总结与展望。该章对全文研究工作和主要结论进行归纳，分析当前机械系统、状态估计和控制框架中仍存在的不足，并提出后续可进一步开展的研究方向。

\begin{figure}[H]
  \centering
  \includegraphics[width=0.77\textwidth]{figures/ch01/research_architecture.png}
  \caption{论文研究内容与技术路线}
